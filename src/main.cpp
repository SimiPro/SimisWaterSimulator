...
class SimisWaterApp final : public bigger::App
{
public:
...
public:
    ...
    MeshObject(const SimisWaterApp* app,
...
private:
    ...
    // Pointer to the app
    const SimisWaterApp* m_app;

    // Assigned resources
    std::shared_ptr<bigger::MeshPrimitive> m_primitive;
};

void SimisWaterApp::initialize(int argc, char** argv)
{
...
void SimisWaterApp::releaseSharedResources()
{
